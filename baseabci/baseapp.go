...
import (
	...
	"github.com/NPC-Chain/npccbase/version"

	ctx "github.com/NPC-Chain/npccbase/context"
	"github.com/NPC-Chain/npccbase/store"
	"github.com/NPC-Chain/npccbase/txs"
	"github.com/NPC-Chain/npccbase/types"
	"github.com/NPC-Chain/npccbase/validator"
...
func (app *BaseApp) validateTxStdUserSignatureAndNonce(cctx ctx.Context, tx *txs.TxStd, qcpFromChainID string) (newctx ctx.Context, result types.Result) {
	...
	for i := 0; i < len(signatures); i++ {
		...
		//issue-68 https://github.com/NPC-Chain/npccbase/issues/68
