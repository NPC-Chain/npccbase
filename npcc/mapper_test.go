...
func defaultCdc() *go_amino.Codec {
	...
	cdc.RegisterConcrete(&txs.QcpTxResult{}, "npccbase/txs/qcpresult", nil)
	cdc.RegisterConcrete(&txs.Signature{}, "npccbase/txs/qcptx", nil)
	cdc.RegisterConcrete(&txs.TxStd{}, "npccbase/txs/stdtx", nil)
